...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.49\textwidth]{figures/first-burn-in-new}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.49\textwidth]{figures/first-parameter-new}
	\includegraphics[width=0.49\textwidth]{figures/second-parameter-new}
%	\tag{1}
...
\begin{figure}%[h!]
	\centering
	\includegraphics[width=0.55\textwidth]{figures/second-burn-in-new}
%	\tag{1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.49\textwidth]{figures/bayes-second-burn-in-first-parameter-new}
	\includegraphics[width=0.49\textwidth]{figures/bayes-second-burn-in-second-parameter-new}
...
\begin{figure}%[h!]
	\centering
	\includegraphics[width=0.49\textwidth]{figures/bayes-acf-second-burn-in-new}
...
In order to justify the length of \(10^4\) of our final MCMC simulation for the approximation of the posterior we use the Gelman-Rubin diagnostic. Therefore we run a second chain with a random starting value sampled from a Gaussian distribution centered around the mean of the second half of the first burn in period and twice the variance of the second burn in period. Then we use the pre-implemented function {\tt gelman.diag} that computes the \(\hat R\) value. \todo{finish this}
\end{emp}
