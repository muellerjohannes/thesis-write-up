...
\begin{emp}[Definition of the slice sampling]
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{Slice-sampling-neal-new}
%	\tag{1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.42\textwidth]{slice-alpha-small}
	\includegraphics[width=0.42\textwidth]{slice-auto-alpha-small}
	\includegraphics[width=0.42\textwidth]{slice-alpha-optimal}
	\includegraphics[width=0.42\textwidth]{slice-auto-alpha-optimal}
	\includegraphics[width=0.42\textwidth]{slice-alpha-big}
	\includegraphics[width=0.42\textwidth]{slice-auto-alpha-big}
%	\tag{1}
...
We seek an expression of the MH random walk and the slice sampling that purely relies on those bounds \(f_n^-\) and \(f_n^+\) of the unnormalised density.
\end{emp}
