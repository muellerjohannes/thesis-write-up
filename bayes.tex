...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/first-burn-in}
%	\tag{1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/first-parameter}
	\includegraphics[width=0.45\textwidth]{figures/second-parameter}
%	\tag{1}
	\caption{Plots of the two state parameters of the MH random walk. It is clearly visible that the acceptance rate drops significantly and hardly any proposals are accepted.}
	\label{fig:MCplot}
\end{figure}
\end{emp}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/bayes-second-burn-in-first-parameter}
	\includegraphics[width=0.45\textwidth]{figures/bayes-second-burn-in-second-parameter}
%	\tag{1}
	\caption{A plot of the samples of the MH of the second burn in period. One can see how the points are distributed around the MLE which is marked green. Their empirical covariance will be used to tune the proposal.}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/bayes-mle-and-regmle}
%	\tag{1}
...
\begin{figure}%[h!]
	\centering
	\includegraphics[width=0.45\textwidth]{figures/bayes-final-MH-first-parameter}
	\includegraphics[width=0.45\textwidth]{figures/bayes-final-MH-second-parameter}
%	\tag{1}
	\caption{A plot of the samples of the MH of the second burn in period. One can see how the points are distributed around the MLE which is marked green. Their empirical covariance will be used to tune the proposal.}
	\label{fig:mixing-final}
\end{figure}
\end{emp}
