...
The small \(\hat R\) values imply that the length of the MH random walk was not too short. Figure \ref{} shows a plot of the evolution of the \(\hat R\) value with increasing length of the chain and it suggests that the length of the chain was not unreasonably long. % since it only c
