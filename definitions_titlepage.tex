...
{\Huge Parameter estimation and consistency  \\[.2cm] for discrete %\\[.2cm] 
...
%\begin{center}
\begin{minipage}{15cm}%\setlength{\parindent}{\myindent}
\centering
\textsc{\Large Professor Nikolaos Zygouras and Professor Theodoros Damoulas}\\[.6cm]
\end{minipage} \\[.6cm]
%\end{center}
