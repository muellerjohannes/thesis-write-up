...
\end{cor}
\begin{proof}
We have already seen in the beginning that this condition is necessary. To see that it is sufficient, let \(0\le K\le I\) hold. Then the point process \(\tilde{\mathbb P}\) from the provious theorem clearly exists and is a DPP with marginal kernel \(K\).
\end{proof}

\begin{cor}[Cardinality of DPPs]
