...
Since it is straight forward to construct examples where the regularised MLE is not consistent. For example if the regulariser \(R\) is equal to \(-\infty\) on a neighborhood of \(\theta_0\), then none of the regularised estimators will lie in this neighborhood and hence the estimations will not converge towards \(\theta_0\).
